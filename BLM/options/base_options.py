...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--segmroot', type=str, default='./weights/CE-Net-Vessel-DRIVE-85.th',
                                 help='path to degraded imgs ON MY WORK STATION')
        ...
        self.parser.add_argument('--which_model_netG', type=str, default='encode_decode_vessel_2scale_share_res_atten',
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='./encode_decode_vessel_2scale_atten10_dagrad3',
                                 help='models are saved here encode_decode_vessel_res')
        ...
        self.parser.add_argument('--dataset_mode', type=str, default='single',
                                 help='chooses how datasets are loaded. [aliged_spera_single | aligned | single]')
        self.parser.add_argument('--model', type=str, default='test',
                                 help='chooses which model to use. test, HDRCNN and HDRCNN_2SCALE_SHARE')
